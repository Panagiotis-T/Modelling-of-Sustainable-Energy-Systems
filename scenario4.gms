...
Power_consumption2(t) PV heat prod
...
Total_Cost..z =e= sum((t)$subt(t),ep*(p2(t)+50*v(t)));

Power_consumption(t)$subt(t).. p(t) =e= w(t)*u(t) ;

Power_consumption2(t)$subt(t).. p2(t) =g= w(t)*u(t)-pv(t);
...
display z.l,COP,s.l,p.l,heatprod.l;

execute_unload "resultsscenario4.gdx" z.l,COP,s.l,p.l,heatprod.l,u.l,l.l

execute 'gdxxrw.exe resultsscenario4.gdx var=z.l,COP,s.l,p.l,heatprod.l,u.l'
execute '=gdx2xls resultsscenario4.gdx'
execute '=shellExecute resultsscenario4.xlsx';
