...
Heat_flow3(t) heat at fill up at t=168

*dem(t) demand
stmax(t) maximum storage
st1(t) startup constraint at t=1
st2(t) another startup at t>1
st3(t) fillup at t=168
;

Total_Cost..z =e= sum((t)$subt(t),ep*(p(t)+50*v(t)));
...
execute_unload "resultsscenario2.gdx" z.l,COP,s.l,p.l,heatprod.l,u.l,l.l

execute 'gdxxrw.exe resultsscenario2.gdx var=z.l,COP,s.l,p.l,heatprod.l,u.l'
execute '=gdx2xls resultsscenario2.gdx'
execute '=shellExecute resultsscenario2.xlsx';
